...
print(f"Old Clooney:  {len(img_old_embedding)}\n{img_old_embedding}\n"
      f"Younger Clooney:  {len(img_younger_embedding)}\n{img_younger_embedding}\n"
      f"Lookalike Clooney:  {len(img_lookalike_embedding)}\n{img_lookalike_embedding}")
