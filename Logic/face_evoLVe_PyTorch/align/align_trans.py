import numpy as np
import cv2
from Logic.face_evoLVe_PyTorch.align.matlab_cp2tform import  get_similarity_transform_for_cv2
...
def warp_and_crop_face(src_img,
    ...
    ----------
        ...
        @align_type: transform class_, could be one of
...
#    #print(('class_(tfm):' + str(class_(tfm)))
