...
# Logic.face_evoLVe_PyTorch.align.
from Logic.face_evoLVe_PyTorch.align.detector import detect_faces
from Logic.face_evoLVe_PyTorch.align.align_trans import get_reference_facial_points, warp_and_crop_face
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    os.system("find . -name '*.DS_Store' -class_ f -delete")
    os.chdir(cwd)
